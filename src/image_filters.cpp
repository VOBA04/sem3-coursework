...
std::string Filter::get_filter_name() { return name; }

Mat Filter::apply() { return image; }
...
CustomFilter::CustomFilter(std::string name, Mat image, int br, int co, int st,
                           int cl, int tmp) {
  this->name = name;
  this->image = image;
  brightness = br;
...
int Filter::get_brightness() { return brightness; }

int Filter::get_contrast() { return contrast; }

int Filter::get_saturation() { return saturation; }

int Filter::get_clarity() { return clarity; }

int Filter::get_temperature() { return temperature; }